...
//        recyclerView.setHasFixedSize(true);
        ...
        adapterRecent = new AdapterRecent(getActivity(), recyclerView, new ArrayList<Wallpaper>());
    ...
    private void requestListPostApi(final int page_no) {
        ...
        callbackCall = apiInterface.getChannel(page_no, Config.LOAD_MORE, type, Config.DEVELOPER_NAME);
