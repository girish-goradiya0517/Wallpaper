...
//        recyclerView.setHasFixedSize(true);
    ...
    private void requestListPostApi(final int page_no) {
        ...
        callbackCall = apiInterface.getCategoryWallpaper(category.cid, page_no, Config.LOAD_MORE, Constant.ADDED_NEWEST, Config.DEVELOPER_NAME);
        ...
        callbackCall.enqueue(new Callback<CallbackCategoryDetails>() {
            ...
            public void onResponse(Call<CallbackCategoryDetails> call, Response<CallbackCategoryDetails> response) {
                ...
                if (resp != null && resp.status.equals("ok")) {
                    ...
                    displayApiResult(resp.wallpapers);
                } else {
